  ...
  return (
    <div className="bg-slate-900/70 backdrop-blur-sm rounded-2xl border border-white/10 p-5 shadow-xl shadow-black/30">
      <div className="flex items-center gap-2 mb-4">
        <span className="text-[10px] text-slate-600 font-mono tracking-widest">03</span>
        <h2 className="text-sm font-semibold text-slate-300 tracking-wide uppercase">기능</h2>
      </div>
      <div>
