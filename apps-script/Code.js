...
function commandListCommand() {
  ...
  var detail = [
    ...
    "[판정·액션] !판정/!<스탯> · !액션/!<액션> · !설득/!기만/!협박",
    "[능력]      !화력/!방호/!치유/!재생/!간섭/!강화 <랭크>",
    "[스킬]      !스킬신청/승인/반려 · !스킬목록 · !스킬 <이름>",
    "[공용스킬]  !공용스킬목록 · !공용스킬 [별명] <이름>",
    "[상태·스택] !상태목록/부여/해제 · !스택목록/스택 · !상태템플릿목록/보기/부여",
    "[관계·일상] !관계등록/수정/목록 · !일상점사용/회복 · !침식",
    "[전투]      !피해 · !대응 방어/회피/맞대응/무대응",
    "[에너미]    !에너미목록/정보/생성/불러오기/삭제/별명/피해/회복/공격/대응",
    "            !에너미스킬목록/스킬/스킬등록/스킬삭제/템플릿등록/템플릿삭제",
    "[패시브]    !패시브목록 · !패시브등록",
    "[닉네임]    !닉네임목록/추가/삭제",
    ...
    "[캐릭터]",
    "  !내정보",
    "  !캐릭터신청 / !캐릭터승인 <번호> / !캐릭터반려 <번호> <사유>",
    "  !수정 <별명> <항목> <값>  |  !성장 <별명> <항목>",
    "  !경험치 <별명1> [별명2…] <량>",
    "[판정·액션]",
    "  !판정 <스탯> [난이도] [보정]  |  !<스탯> [난이도] [보정]",
    "  !액션 <액션> [난이도] [보정]  |  !<액션> [난이도] [보정]",
    "  !설득 / !기만 / !협박",
    "[능력]  !화력/!방호/!치유/!재생/!간섭/!강화 <랭크>",
    "[스킬]",
    "  !스킬신청 / !스킬승인 <번호> / !스킬반려 <번호> <사유>",
    "  !스킬목록  |  !스킬 <이름>",
    "[공용스킬]",
    "  !공용스킬목록 [별명]  |  !공용스킬 [별명] <이름> [대상:이름] [보정]",
    "[상태·스택]",
    "  !상태목록 / !상태부여 <대상> <이름> …옵션 / !상태해제 <대상> <이름>",
    "  !스택목록 / !스택 <대상> <이름> <변동>",
    "  !상태템플릿목록 / !상태템플릿보기 <이름> / !상태템플릿부여 <대상> <이름>",
    "[관계·일상·침식]",
    "  !관계등록 / !관계수정 / !관계목록",
    "  !일상점사용 / !일상점회복  |  !침식 <대상> <변동>",
    "[전투]",
    "  !피해 <별명> <수치>",
    "  !대응 방어/회피/무대응 [보정]",
    "  !대응 맞대응 <액션명|화력 랭크|스킬 이름> [보정]",
    "[에너미]",
    "  !에너미목록 / !에너미정보 <별명>",
    "  !에너미생성 / !에너미불러오기 / !에너미삭제 / !에너미별명 <기존> <신규>",
    "  !에너미피해/회복/공격/대응 <별명> …",
    "  !에너미스킬목록/스킬/스킬등록/스킬삭제/템플릿등록/템플릿삭제 <별명> …",
    "[패시브]",
    "  !패시브목록 [별명/에너미ID]  |  !패시브등록 (멀티라인 필드:값)",
    "[닉네임]",
    "  !닉네임목록 [별명] / !닉네임추가 <별명> <닉1> … / !닉네임삭제 <별명> <닉>",
    "[인벤·장비]",
    "  !인벤토리 [별명] / !장비 [별명]",
    "  !아이템지급 <별명> <이름> [수량] / !아이템삭제 <id> / !아이템사용 <이름>",
    "  !장비착용 [별명] <이름> / !장비해제 [별명] <슬롯|이름>",
    "[경제·상점]",
    "  !은화 <별명1>… <금액>  (+지급/-차감, GM)",
    "  !교환 <상대> <아이템|은화> [수량|금액]",
    "  !퀵슬롯1/2/3 [대상:별명]  |  !<아이템명> (퀵슬롯 단축)",
    "  ※ 상점구매·퀵슬롯등록은 웹빌더에서",
    "[세션]",
