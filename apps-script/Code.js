...
function commandListCommand() {
  var summary = [
    ...
    "[스킬]    !스킬신청 / !스킬승인/반려 / !스킬목록 / !스킬 <명>",
    "[공용스킬] !공용스킬목록 / !공용스킬 <명>",
    "[상태·스택] !상태부여/해제 / !스택 / !상태템플릿부여",
    "[관계·일상·침식] !관계등록/수정/목록 / !일상점 / !침식",
    "[전투]    !피해 / !대응 방어/회피/맞대응/무대응",
    "[에너미]  !에너미생성/정보/공격/스킬 등",
    "[패시브]  !패시브목록 / !패시브등록",
    "[닉네임]  !닉네임목록/추가/삭제",
    "[인벤·장비] !인벤토리 / !장비 / !아이템사용",
    "[경제]    !은화 / !교환 / !퀵슬롯1~3",
  ...
  var detail = [
    ...
    "  !스킬목록 / !스킬 <스킬명>",
    "  !공용스킬목록 [별명] / !공용스킬 [별명] <명> [대상:명] [보정]",
    "",
    "[상태·스택]",
    "  !상태목록 / !상태부여 <대상> <상태명> / !상태해제 <대상> <상태명>",
    "  !스택목록 / !스택 <대상> <스택명> <변동>",
    "  !상태템플릿목록 / !상태템플릿보기 <명> / !상태템플릿부여 <대상> <명>",
    "",
    "[관계·일상·침식]",
    "  !관계등록 / !관계수정 / !관계목록",
    "  !일상점사용 / !일상점회복",
    ...
    "  !에너미피해/회복 <별명> <수치>",
    "  !에너미공격/대응 <별명> …",
    "  !에너미스킬목록 <별명> / !에너미스킬 <별명> <명>",
    "  !에너미스킬등록/삭제 / !에너미템플릿등록/삭제",
    "",
    "[패시브]",
    "  !패시브목록 [별명/에너미ID]",
    "  !패시브등록 (멀티라인: key/이름/소유타입/소유키/…/효과/설명)",
    "",
    "[닉네임]",
    "  !닉네임목록 [별명] / !닉네임추가 별명 닉1 닉2… / !닉네임삭제 별명 닉",
    "",
    "[인벤·장비]",
    "  !인벤토리 [별명] / !장비 [별명]",
    "  !아이템지급 <별명> <명> [수량] / !아이템삭제 <id>",
    "  !장비착용/해제 [별명] <명|슬롯>",
    "  !아이템사용 <명> [대상:별명]",
    "",
    "[경제·상점]",
    ...
    "  !퀵슬롯1/2/3 [대상:별명]  (상점·퀵슬롯 등록은 웹 빌더에서)",
    "",
    "[세션]",
    "  !fin [메시지/별명…]",
    "    --keep-status  상태 유지  --keep-stack  스택 유지  --no-clear  정리 없음",
    "",
    "━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "<> 필수  [] 선택"
  ].join("\n");
...
function commandListSummary() {
  return (
    ...
    "     APORIA 명령어 목록\n" +
    "━━━━━━━━━━━━━━━━━━━━━━━━━━\n" +
    "[캐릭터]  !내정보 / !캐릭터신청 / !수정 / !성장 / !경험치\n" +
    "[판정·액션] !판정 / !액션 / !설득 / !기만 / !협박\n" +
    "[능력]    !화력/방호/치유/재생/간섭/강화 <랭크>\n" +
    "[스킬]    !스킬신청 / !스킬목록 / !스킬 / !공용스킬\n" +
    "[상태·스택] !상태부여/해제 / !스택 / !상태템플릿부여\n" +
    "[전투]    !피해 / !대응\n" +
    "[에너미]  !에너미생성/공격/스킬 등\n" +
    "[패시브]  !패시브목록 / !패시브등록\n" +
  ...
  if (passives.length > 0) {
    ...
    for (var j = 0; j < passives.length; j++) {
      ...
      try {
        ...
        if (pOwnerType === "global") { pOwnerType = "character"; }
        if (pOwnerKey  === "*")      { pOwnerKey  = charName; }
