...
function commandListCommand() {
  var summary = [
    ...
    "     APORIA 명령어 목록",
    "━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "[캐릭터]    !내정보/신청/승인/반려/수정/성장/경험치",
    "[판정·액션] !판정/<스탯> / !액션/<액션>",
    "            !설득/기만/협박",
    "[능력]      !화력/방호/치유/재생/간섭/강화 <랭크>",
    "[스킬]      !스킬신청/승인/반려/목록/스킬",
    "[공용스킬]  !공용스킬목록 / !공용스킬",
    "[상태·스택] !상태목록/부여/해제 / !스택목록/스택",
    "            !상태템플릿목록/보기/부여",
    "[관계·일상] !관계등록/수정/목록 / !일상점 / !침식",
    "[전투]      !피해 / !대응(방어/회피/맞대응/무대응)",
    "[에너미]    !에너미목록/정보/생성/삭제/별명",
    "            !에너미피해/회복/공격/대응/스킬",
    "[패시브]    !패시브목록 / !패시브등록",
    "[닉네임]    !닉네임목록/추가/삭제",
    "[인벤·장비] !인벤토리/장비/아이템지급/삭제/착용/해제/사용",
    "[경제]      !은화 / !교환 / !퀵슬롯1~3",
    "[세션]      !fin [--keep-status/--keep-stack/--no-clear]",
    "━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "<> 필수  [] 선택"
  ].join("\n");
  ...
  var detail = [
    ...
    "",
    "[ 판정 · 액션 ]",
    "  !판정 <스탯명> [난이도] [보정]  ·  !<스탯명> (단축)",
    "  !액션 <액션명> [난이도] [보정]  ·  !<액션명> (단축)",
    "  !설득 / !기만 / !협박",
    "",
    "[ 능력 ]",
    "  !화력 / !방호 / !치유 / !재생 / !간섭 / !강화  <랭크>",
    "",
    "[ 스킬 ]",
    ...
    "[ 공용 스킬 ]",
    "  !공용스킬목록 [별명]",
    "  !공용스킬 [별명] <스킬명> [대상:대상명] [보정]",
    "",
    "[ 상태 · 스택 ]",
    "  !상태목록 / !상태부여 <대상> <상태명> / !상태해제 <대상> <상태명>",
    "  !스택목록 / !스택 <대상> <스택명> <변동>",
    ...
    "  !에너미피해/회복 <별명> <수치>",
    "  !에너미공격/대응 <별명> …",
    "  !에너미스킬목록/스킬 / !에너미스킬등록/삭제",
    "  !에너미템플릿등록 / !에너미템플릿삭제",
    "",
    "[ 패시브 ]",
    "  !패시브목록 [별명/에너미ID] / !패시브등록",
    "",
    "[ 닉네임 ]",
    "  !닉네임목록 [별명] / !닉네임추가 별명 닉네임… / !닉네임삭제 별명 닉네임",
    "",
    "[ 인벤토리 · 장비 ]",
    "  !인벤토리/장비 [별명]",
    "  !아이템지급 <별명> <아이템명> [수량]  (GM 전용)",
    "  !아이템삭제 <인벤토리id>  (GM 전용)",
    "  !장비착용/해제 [별명] <아이템명|슬롯>",
    "  !아이템사용 <아이템명> [대상:별명]",
    "",
    ...
    "[ 세션 ]",
    "  !fin [메시지/별명…]",
    "  옵션: --keep-status / --keep-stack / --no-clear",
    "",
    "━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "<> 필수  [] 선택"
  ].join("\n");
...
function commandListSummary() {
  return [
    ...
    "[능력]      !화력/방호/치유/재생/간섭/강화 <랭크>",
    "[스킬]      !스킬신청/승인/반려/목록/스킬",
    "[상태·스택] !상태목록/부여/해제 / !스택목록/스택 / !상태템플릿",
    "[관계·일상] !관계등록/수정/목록 / !일상점 / !침식",
    "[전투]      !피해 / !대응(방어/회피/맞대응/무대응)",
    "[에너미]    !에너미목록/정보/생성/삭제/공격/스킬",
    "[인벤·장비] !인벤토리/장비/아이템지급/착용/해제/사용",
    "[경제]      !은화 / !교환 / !퀵슬롯1~3",
    "[세션]      !fin / !패시브목록/등록",
    "━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "상세 보기: !명령어목록"
...
function registerPortalCharacterData(payload, outputText, application) {
  ...
  if (passives.length > 0) {
    ...
    for (var j = 0; j < passives.length; j++) {
      ...
      try {
        var pOwnerType = String(p["소유타입"] || "global");
        var pOwnerKey  = String(p["소유키"]   || "*");
        if (pOwnerType === "global") {
          pOwnerType = "character";
          pOwnerKey  = charName;
        }
